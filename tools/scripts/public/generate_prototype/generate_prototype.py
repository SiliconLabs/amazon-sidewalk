...
site_packages_path = os.path.abspath(os.path.join(os.path.dirname(__file__), 'python/ext-site-packages/{}'.format(platform_dir_name)))
...
try:
    ...
    BASE_ADDRESS = {
        0x00000000: ['xg21'],
        0x08000000: ['xg23', 'xg24', 'xg25', 'xg26', 'xg27', 'xg28', 'xg29']
    }
    ...
    try:
        os.makedirs(os.path.join( args.output, "mfg_output"))
    except FileExistsError:
        pass
