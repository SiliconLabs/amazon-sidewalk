...
MFG_NVM3_KEY_BASE = 0xA9000 # see component/amazon/projects/sid/sal/silabs/sid_pal/include/nvm3_manager.h
...
class SidMfgValueId(Enum):
    ...
    SID_PAL_MFG_STORE_MAGIC = (MFG_NVM3_KEY_BASE + 0x0, 4)
    SID_PAL_MFG_STORE_DEVID = (MFG_NVM3_KEY_BASE + 0x1, 5)
    SID_PAL_MFG_STORE_VERSION = (MFG_NVM3_KEY_BASE + 0x2, 4)
    SID_PAL_MFG_STORE_SERIAL_NUM = (MFG_NVM3_KEY_BASE + 0x3, 17)
    SID_PAL_MFG_STORE_SMSN = (MFG_NVM3_KEY_BASE + 0x4, 32)
    SID_PAL_MFG_STORE_APP_PUB_ED25519 = (MFG_NVM3_KEY_BASE + 0x5, 32)
    SID_PAL_MFG_STORE_DEVICE_PRIV_ED25519 = (MFG_NVM3_KEY_BASE + 0x6, 32)
    SID_PAL_MFG_STORE_DEVICE_PUB_ED25519 = (MFG_NVM3_KEY_BASE + 0x7, 32)
    SID_PAL_MFG_STORE_DEVICE_PUB_ED25519_SIGNATURE = (MFG_NVM3_KEY_BASE + 0x8, 64)
    SID_PAL_MFG_STORE_DEVICE_PRIV_P256R1 = (MFG_NVM3_KEY_BASE + 0x9, 32)
    SID_PAL_MFG_STORE_DEVICE_PUB_P256R1 = (MFG_NVM3_KEY_BASE + 0xA, 64)
    SID_PAL_MFG_STORE_DEVICE_PUB_P256R1_SIGNATURE = (MFG_NVM3_KEY_BASE + 0xB, 64)
    SID_PAL_MFG_STORE_DAK_PUB_ED25519 = (MFG_NVM3_KEY_BASE + 0xC, 32)
    SID_PAL_MFG_STORE_DAK_PUB_ED25519_SIGNATURE = (MFG_NVM3_KEY_BASE + 0xD, 64)
    SID_PAL_MFG_STORE_DAK_ED25519_SERIAL = (MFG_NVM3_KEY_BASE + 0xE, 4)
    SID_PAL_MFG_STORE_DAK_PUB_P256R1 = (MFG_NVM3_KEY_BASE + 0xF, 64)
    SID_PAL_MFG_STORE_DAK_PUB_P256R1_SIGNATURE = (MFG_NVM3_KEY_BASE + 0x10, 64)
    SID_PAL_MFG_STORE_DAK_P256R1_SERIAL = (MFG_NVM3_KEY_BASE + 0x11, 4)
    SID_PAL_MFG_STORE_PRODUCT_PUB_ED25519 = (MFG_NVM3_KEY_BASE + 0x12, 32)
    SID_PAL_MFG_STORE_PRODUCT_PUB_ED25519_SIGNATURE = (MFG_NVM3_KEY_BASE + 0x13, 64)
    SID_PAL_MFG_STORE_PRODUCT_ED25519_SERIAL = (MFG_NVM3_KEY_BASE + 0x14, 4)
    SID_PAL_MFG_STORE_PRODUCT_PUB_P256R1 = (MFG_NVM3_KEY_BASE + 0x15, 64)
    SID_PAL_MFG_STORE_PRODUCT_PUB_P256R1_SIGNATURE = (MFG_NVM3_KEY_BASE + 0x16, 64)
    SID_PAL_MFG_STORE_PRODUCT_P256R1_SERIAL = (MFG_NVM3_KEY_BASE + 0x17, 4)
    SID_PAL_MFG_STORE_MAN_PUB_ED25519 = (MFG_NVM3_KEY_BASE + 0x18, 32)
    SID_PAL_MFG_STORE_MAN_PUB_ED25519_SIGNATURE = (MFG_NVM3_KEY_BASE + 0x19, 64)
    SID_PAL_MFG_STORE_MAN_ED25519_SERIAL = (MFG_NVM3_KEY_BASE + 0x1A, 4)
    SID_PAL_MFG_STORE_MAN_PUB_P256R1 = (MFG_NVM3_KEY_BASE + 0x1B, 64)
    SID_PAL_MFG_STORE_MAN_PUB_P256R1_SIGNATURE = (MFG_NVM3_KEY_BASE + 0x1C, 64)
    SID_PAL_MFG_STORE_MAN_P256R1_SERIAL = (MFG_NVM3_KEY_BASE + 0x1D, 4)
    SID_PAL_MFG_STORE_SW_PUB_ED25519 = (MFG_NVM3_KEY_BASE + 0x1E, 32)
    SID_PAL_MFG_STORE_SW_PUB_ED25519_SIGNATURE = (MFG_NVM3_KEY_BASE + 0x1F, 64)
    SID_PAL_MFG_STORE_SW_ED25519_SERIAL = (MFG_NVM3_KEY_BASE + 0x20, 4)
    SID_PAL_MFG_STORE_SW_PUB_P256R1 = (MFG_NVM3_KEY_BASE + 0x21, 64)
    SID_PAL_MFG_STORE_SW_PUB_P256R1_SIGNATURE = (MFG_NVM3_KEY_BASE + 0x22, 64)
    SID_PAL_MFG_STORE_SW_P256R1_SERIAL = (MFG_NVM3_KEY_BASE + 0x23, 4)
    SID_PAL_MFG_STORE_AMZN_PUB_ED25519 = (MFG_NVM3_KEY_BASE + 0x24, 32)
...
ARG_GROUPS = [
    ...
    SidPlatformArgs(
        ...
        chips=[
            ...
            SidChipAddr(name="xg29", full_name="EFR32BG29B220F1024CJ45", offset_addr=0x080F8000),
        ],
    ),
    SidPlatformArgs(
