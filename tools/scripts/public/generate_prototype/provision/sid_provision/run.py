...
ARG_GROUPS = [
    ...
    SidPlatformArgs(
        ...
        chips=[
            SidChipAddr(name="xg21", full_name="EFR32MG21B020F1024IM32", offset_addr=0x000F2000),
            SidChipAddr(name="xg24", full_name="EFR32MG24BA020F1536GM48", offset_addr=0x08172000, default=True),
            SidChipAddr(name="xg28", full_name="EFR32ZG28B322F1024IM68", offset_addr=0x080F2000),
            SidChipAddr(name="xg23", full_name="EFR32ZG23B020F512IM48", offset_addr=0x8072000),
        ],
    ),
    SidPlatformArgs(
