...
enum event_type {
  ...
  EVENT_TYPE_SEND,
  EVENT_TYPE_GET_LINK_CONNECTION_POLICY,
  EVENT_TYPE_SET_LINK_CONNECTION_POLICY,
  EVENT_TYPE_GET_MULTI_LINK_POLICY,
  EVENT_TYPE_SET_MULTI_LINK_POLICY,
  EVENT_TYPE_GET_AUTO_CONNECT_PARAMS,
  EVENT_TYPE_SET_AUTO_CONNECT_PARAMS,
#if defined(SL_SIDEWALK_OTA_DFU_PRESENT)
  EVENT_TYPE_SID_OTA_DFU_INIT_REQUEST,
  EVENT_TYPE_SID_OTA_DFU_DEINIT_REQUEST,
  EVENT_TYPE_SID_OTA_DFU_CANCEL_REQUEST,
  EVENT_TYPE_SID_OTA_DFU_STAT_REQUEST,
  EVENT_TYPE_SID_OTA_DFU_PARAM_REQUEST,
  EVENT_TYPE_SID_OTA_DFU_MIN_SCRATCH_BUF_SIZE_REQUEST,
  EVENT_TYPE_SID_OTA_DFU_RELEASE_BUFFER,
#endif
#if defined(SID_SDK_INTERNAL_CONFIG_ENABLE_DULT_QA)
  EVENT_TYPE_DULT_INIT,
  EVENT_TYPE_DULT_DEINIT,
  EVENT_TYPE_DULT_START,
  EVENT_TYPE_DULT_STOP,
  EVENT_TYPE_DULT_STATUS,
#endif
  EVENT_TYPE_INVALID
};
