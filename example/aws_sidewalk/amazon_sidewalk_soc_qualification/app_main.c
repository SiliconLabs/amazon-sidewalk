...
#define MAIN_TASK_STACK_SIZE    (5376 / sizeof(configSTACK_DEPTH_TYPE))
...
static void set_sub_ghz_cfg(const struct sid_sub_ghz_links_config *sub_ghz_cfg)
{
  if (!sub_ghz_cfg) {
...
static void main_thread(void * context)
{
  ...
  #if defined(SL_CATALOG_POWER_MANAGER_PRESENT)
  #if defined(EFR32XG28)
  // XG28 RTT requires EM1
  if ((CoreDebug->DHCSR & CoreDebug_DHCSR_C_DEBUGEN_Msk)) {
    app_log_info("RTT requires EM1...");
