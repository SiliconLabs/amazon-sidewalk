...
void sl_sidewalk_location_cli_scan_and_send(sl_cli_command_arg_t *arguments)
{
  enum sid_location_effort_mode effort = sl_cli_get_argument_uint32(arguments, 0);
  app_trigger_location_scan_and_send(effort);
}

#if defined(SL_LOCATION_FULL)
void sl_sidewalk_location_cli_scan_only(sl_cli_command_arg_t *arguments)
{
  enum sid_location_effort_mode effort = sl_cli_get_argument_uint32(arguments, 0);
  app_trigger_location_scan_only(effort);
}

void sl_sidewalk_location_cli_send_only(sl_cli_command_arg_t *arguments)
{
  enum sid_location_effort_mode effort = sl_cli_get_argument_uint32(arguments, 0);
  app_trigger_location_send_only(effort);
}
