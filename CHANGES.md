...
From the v2.5.0 version the release notes will be published in an other place. Please check the [link](https://docs.silabs.com/sisdk-release-notes/latest/sisdk-release-notes-overview/).
...
*SiSDK 2024.12.0 - Amazon Sidewalk SDK 1.17.0*
