...
void sl_sidewalk_location_cli_callback(const struct sid_location_result *const result, void *context)
{
  ...
  SL_SID_LOG_APP_INFO("location result: %d", result->err);
  ...
  if ((result->mode == SID_LOCATION_EFFORT_L3) ||
    ...
    if ((result->err == SID_ERROR_NONE) &&
        (result->status == SID_LOCATION_SCAN_ONLY_DONE) &&
        (result->size > 0)) {
 ...
 *****************************************************************************/
WEAK void sl_sidewalk_location_cli_scan_and_send(sl_cli_command_arg_t *arguments)
{
  (void)arguments;
  SL_SID_LOG_APP_INFO("location cli: scan_and_send not implemented");
}
 ...
 *****************************************************************************/
WEAK void sl_sidewalk_location_cli_scan_only(sl_cli_command_arg_t *arguments)
{
  (void)arguments;
  SL_SID_LOG_APP_INFO("location cli: scan_only not implemented");
}
 ...
 * @param[in] arguments CLI command arguments containing the effort mode (L3-L4)
 *****************************************************************************/
WEAK void sl_sidewalk_location_cli_send_only(sl_cli_command_arg_t *arguments)
{
  (void)arguments;
  SL_SID_LOG_APP_INFO("location cli: send_only not implemented");
}
