...
sl_sid_app_msg_st_t sl_sid_app_msg_dev_mgmt_rst_dev_prepare_send(sl_sid_app_msg_dev_mgmt_rst_dev_ctx_t *ctx,
                                                                 sl_sid_app_msg_t *send_app_msg)
{
  SLI_SID_APP_MSG_CLR_PROCESSING_FLAG(ctx);

  if (ctx->hdl.operation == SL_SID_APP_MSG_OP_SET) {
    return SLI_SID_APP_MSG_PREP_SEND_ACK_FUNC(SLI_SID_APP_MSG_CMD_CLS_DEV_MGMT,
                                              SLI_SID_APP_MSG_CMD_ID_DEV_MGMT_RST_DEV);
  } else if (ctx->hdl.operation == SL_SID_APP_MSG_OP_NTFY) {
    return SLI_SID_APP_MSG_PREP_SEND_PARAM_FUNC(SLI_SID_APP_MSG_CMD_CLS_DEV_MGMT,
                                                SLI_SID_APP_MSG_CMD_ID_DEV_MGMT_RST_DEV);
  } else {
    return SL_SID_APP_MSG_ERR_ST_APP_WRONG_OP;
  }
...
sl_sid_app_msg_st_t sl_sid_app_msg_dev_mgmt_button_press_prepare_send(sl_sid_app_msg_dev_mgmt_button_press_ctx_t *ctx,
                                                                      sl_sid_app_msg_t *send_app_msg)
{
  SLI_SID_APP_MSG_CLR_PROCESSING_FLAG(ctx);
...
sl_sid_app_msg_st_t sl_sid_app_msg_dev_mgmt_toggle_led_prepare_send(sl_sid_app_msg_dev_mgmt_toggle_led_ctx_t *ctx,
                                                                    sl_sid_app_msg_t *send_app_msg)
{
  SLI_SID_APP_MSG_CLR_PROCESSING_FLAG(ctx);
...
SL_WEAK void sl_sid_app_msg_dev_mgmt_rst_dev_cb(sl_sid_app_msg_dev_mgmt_rst_dev_ctx_t *ctx)
{
  (void)ctx;
}

SL_WEAK void sl_sid_app_msg_dev_mgmt_button_press_cb(sl_sid_app_msg_dev_mgmt_button_press_ctx_t *ctx)
{
  (void)ctx;
}

SL_WEAK void sl_sid_app_msg_dev_mgmt_toggle_led_cb(sl_sid_app_msg_dev_mgmt_toggle_led_ctx_t *ctx)
{
  (void)ctx;
}
