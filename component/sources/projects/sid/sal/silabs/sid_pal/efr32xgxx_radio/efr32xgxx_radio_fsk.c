...
// -----------------------------------------------------------------------------
static void radio_mp_to_efr32xgxx_mp(efr32xgxx_mod_params_gfsk_t *fsk_mp, const
                                     sid_pal_radio_fsk_modulation_params_t *mod_params);
static void radio_pp_to_efr32xgxx_pp(efr32xgxx_pkt_params_gfsk_t *fsk_pp, const
...
uint32_t sid_pal_radio_fsk_get_fsk_number_of_symbols(const sid_pal_radio_fsk_modulation_params_t *mod_params,
                                                     uint32_t delay_micro_secs)//TODO:Implemnent in the generic way
{
