...
/**************************************************************************//**
 * Queue a message to the sidewalk_sender component
 *
 * @param[in] message The message to queue. It must be a null-terminated string.
 * @param[in] message_length The length of the message. Length without the null terminator.
