                                            ...
                                            uint8_t value_length)
{
  ...
  if (value_length && is_value_hex) {
    ...
    snprintf(value_format_str, sizeof(value_format_str), "%%0%u", value_length);
  } else if (value_length) {
    // Fixed-length value
    snprintf(value_format_str, sizeof(value_format_str), "%%%u", value_length);
  } else {
    snprintf(value_format_str, sizeof(value_format_str), "%%");
  }
  ...
  if (value_enum) {
    snprintf(value_str, sizeof(value_str), "%s (", value_enum->value_str);
  }
