...
{
#ifdef SL_SIDEWALK_CONFIGURATOR_PROPERTIES_BLE_DEVICE_NAME
  .name              = SL_SIDEWALK_CONFIGURATOR_PROPERTIES_BLE_DEVICE_NAME,
#else
  .name              = "SL_SIDEWALK",
#endif
  .mtu               = 247,
  ...
  .profile           = ble_profile,
#ifdef SL_SIDEWALK_CONFIGURATOR_PROPERTIES_BLE_OUTPUT_POWER
  .max_tx_power_in_dbm = SL_SIDEWALK_CONFIGURATOR_PROPERTIES_BLE_OUTPUT_POWER,
#else
  .max_tx_power_in_dbm = SL_BT_CONFIG_MAX_TX_POWER / 10,
#endif
