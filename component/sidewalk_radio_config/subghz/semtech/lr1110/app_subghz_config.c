...
const radio_lr11xx_regional_param_t radio_lr11xx_regional_param[] = {
    ...
    #define MAX_TX_POWER SL_SIDEWALK_CONFIGURATOR_PROPERTIES_SUBGHZ_OUTPUT_POWER
    #else
    #define MAX_TX_POWER RADIO_MAX_TX_POWER_EU
    #endif
      .max_tx_power     = { MAX_TX_POWER, MAX_TX_POWER, MAX_TX_POWER,
                          MAX_TX_POWER, MAX_TX_POWER, MAX_TX_POWER },
      .cca_level_adjust = { 0, 0, 0, 0, 0, 0 },
...
__attribute__( ( weak ) ) const void* gnss_scan_done_context = NULL;
__attribute__( ( weak ) ) const void* wifi_scan_done_context = NULL;
...
struct sid_sub_ghz_links_config lr11xx_sub_ghz_link_config = {
