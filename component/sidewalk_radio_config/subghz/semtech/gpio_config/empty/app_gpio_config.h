...
// IRQ line from sx126x/lr11xx chip
// See sx126x/lr11xx datasheet for IRQs list.
...
#error "SL_ANTSW GPIO macros must be defined for SX126X"
#endif
...
#error "SL_ANTSW GPIO macros must be properly configured for SX126X"
#endif
