...
enum sid_option {
    ...
    /** Get the Sidewalk ID for the device. Since Sidewalk ID is given to the device post registration. This option will
     * only work post registration */
...
enum sid_end_device_power_type {
    /** The end device is powered by battery only */
