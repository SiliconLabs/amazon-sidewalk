...
/**
 * @brief Implements a busy wait delay safe to be used in SWI context.
 *
...
/**
 * @brief Implements a delay function using RTOS API call.
 * 
...
/** @} */ // end of sid_pal_delay_ifc group
