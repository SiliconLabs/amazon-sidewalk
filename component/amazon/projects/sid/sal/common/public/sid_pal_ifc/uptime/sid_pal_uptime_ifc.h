...
/**
 * @brief Get the current time of specified clock source
 *
...
/**
 * @brief Set crystal offset for RTC compensation
 *
...
/**
 * @brief Get current crystal offset
 *
...
/** @} */ // end of sid_pal_uptime_ifc group