...
/**************************************************************************//**
 * @addtogroup sid_pal_gpio_ifc_types Type definitions
 * @ingroup sid_pal_gpio_ifc
 * @{
 *****************************************************************************/
/**
 ...
 * @param[in] callback_arg      The argument to be passed to the callback function.
 */
