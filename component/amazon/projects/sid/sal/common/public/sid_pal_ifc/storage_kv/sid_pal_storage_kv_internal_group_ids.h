 ...
 */
 ...
 /**
 * @def SID_PAL_STORAGE_KV_INTERNAL_PROTOCOL_GROUP_ID
 * @brief Group ID for the internal protocol of the Key-Value storage.
 */
...
#define SID_PAL_STORAGE_KV_INTERNAL_PROTOCOL_GROUP_ID 0x2000
 ...
 /**
 * @def SID_PAL_STORAGE_KV_INTERNAL_CONFIG_GROUP_ID
 * @brief Group ID for the internal configuration of the Key-Value storage.
 */
...
#define SID_PAL_STORAGE_KV_INTERNAL_CONFIG_GROUP_ID 0x3456
 ...
 /**
 * @def SID_PAL_STORAGE_KV_INTERNAL_BULK_DATA_TRANSFER_GROUP_ID
 * @brief Group ID for the internal bulk data transfer of the Key-Value storage.
 */
