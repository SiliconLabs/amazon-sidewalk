 ...
 */
/**
 * \addtogroup sid_pal_critical_region_ifc
 * @{
 */
...
/**
 * @brief Implements disabling of all hardware and software interrupts
 */
void sid_pal_enter_critical_region();

/**
 * @brief Implements enabling of all hardware and software interrupts that were previously
...
/** @} */ // end of sid_pal_critical_region_ifc group