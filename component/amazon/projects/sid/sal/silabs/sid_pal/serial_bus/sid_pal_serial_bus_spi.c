                                       ...
                                       size_t xfer_size)
{
  ...
  bool success = client->client_selector_cb ? client->client_selector_cb(client, SID_PAL_SERIAL_BUS_CLIENT_SELECT,
  ...
  success = client->client_selector_cb ? client->client_selector_cb(client, SID_PAL_SERIAL_BUS_CLIENT_DESELECT,
                                                                      client->client_selector_context)
...
sid_error_t sid_pal_serial_bus_efr32_spi_create(const struct sid_pal_serial_bus_iface **iface, const void *cfg)
{
  ...
  const struct sid_pal_serial_bus_efr32_spi_config *config = (const struct sid_pal_serial_bus_efr32_spi_config *)cfg;
