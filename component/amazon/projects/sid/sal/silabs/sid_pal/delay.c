...
// -----------------------------------------------------------------------------
static uint32_t get_core_freq_offset(uint32_t core_freq)
{
  return (uint32_t)((0.81 * core_freq) + 7.24);
}
// -----------------------------------------------------------------------------
...
{
  sl_status_t status;
  status = sl_clock_manager_get_clock_branch_frequency(SL_CLOCK_BRANCH_SYSCLK,
                                                       (uint32_t *)&core_freq_coef);
