...
const sl_rail_channel_config_entry_t sidewalk_2gfsk_50kbps_channels[] = {
  {
...
const sl_rail_channel_config_t sidewalk_2gfsk_50kbps_channelConfig = {
  .phy_config_base = sidewalk_2gfsk_50kbps_modemConfigBase,
  .phy_config_delta_subtract = NULL,
  .p_entries = sidewalk_2gfsk_50kbps_channels,
  .number_of_entries = 1U,
  .signature = 602045417UL,
