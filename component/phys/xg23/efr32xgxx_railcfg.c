...
const sl_rail_channel_config_entry_t UNKNOWN_channels[] = {
  {
...
const sl_rail_channel_config_t UNKNOWN_channelConfig = {
  .phy_config_base = UNKNOWN_modemConfigBase,
  .phy_config_delta_subtract = NULL,
  .p_entries = UNKNOWN_channels,
  .number_of_entries = 1U,
  .signature = 1576096717UL,
  .xtal_frequency_hz = 39000000UL,
};
